# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-06-30 04:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agency_logo', models.ImageField(null=True, upload_to=b'prjimages/%Y/%m/%d/%H/%M/%S/')),
            ],
        ),
        migrations.CreateModel(
            name='AgencyMember',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('baseuser_avatar', models.ImageField(null=True, upload_to=b'prjimages/%Y/%m/%d/%H/%M/%S/')),
            ],
            options={
                'abstract': False,
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand_logo', models.ImageField(null=True, upload_to=b'prjimages/%Y/%m/%d/%H/%M/%S/')),
            ],
        ),
        migrations.CreateModel(
            name='Cagetory',
            fields=[
                ...
                ('cagetory_parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='econ.Cagetory')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('product_agency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='econ.Agency')),
                ('product_branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='econ.Brand')),
                ('product_cagetory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='econ.Cagetory')),
            ],
        ),
        migrations.CreateModel(
            name='ProductDetail',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to=b'prjimages/%Y/%m/%d/%H/%M/%S/')),
                ('product', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='econ.Product')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promotion_start', models.DateTimeField(null=True)),
                ('promotion_end', models.DateTimeField(null=True)),
                ('apply_to', models.ManyToManyField(blank=True, null=True, to='econ.Product')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specific_unit', models.CharField(blank=True, max_length=20, null=True)),
                ('specific_of', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='econ.Cagetory')),
            ],
        ),
        migrations.CreateModel(
            name='ProductSpecificDetail',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('detail_value', models.CharField(max_length=50)),
                ('detail_desc', models.CharField(blank=True, max_length=200, null=True)),
                ('detail_field', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='econ.ProductSpecific')),
            ],
        ),
        migrations.AddField(
            model_name='productdetail',
            name='productdetail_detail',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='econ.ProductSpecificDetail'),
        ),
        migrations.AddField(
            model_name='productdetail',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='econ.ProductSpecific'),
        ),
        migrations.AddField(
