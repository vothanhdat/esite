# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-07-13 07:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prod_option', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='econ.ProductOption')),
            ],
        ),
        ...
        migrations.AddField(
            model_name='productoptionspecdetail',
            name='specof',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='econ.Specific'),
        ),
        migrations.AlterUniqueTogether(
            name='productoptionspecdetail',
            unique_together=set([('specof', 'prod_option')]),
        ),
    ]
